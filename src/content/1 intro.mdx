...
So, for example, a call option, which is effectively a bet between two parties, starts with someone making a bet: an option can only come into existence if someone sells it, which is usually called writing an option.
